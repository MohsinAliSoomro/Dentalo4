  ...
  return (
    ...
    <React.Fragment>
      <Navbar style={{ fontSize: '13px', lineHeight:'15px', backgroundColor:'#001f24'}} expand="md">
        <Link href="/">
          <NavLink style={{marginLeft:'20px', color:'white'}}>Notícias &  Mídia</NavLink>
        </Link>
        ...
        <Collapse navbar>
          <Nav className="ml-auto" navbar style={{marginRight:'80px'}}>
            ...
            <NavItem>
                ...
                <NavItem>
                  <Link href="#">
                    <NavLink style={{ color:'white'}}><FaRegClock style={{margin:'0 6 1'}} /> Seg-Sab: 09h-18h</NavLink>
                  </Link>
                </NavItem>

                <NavItem>
                  <Link href="/signin">
                    <NavLink  style={{color:'white', marginRight:'40px'}}><MdLanguage style={{margin:'0 10 3'}}/>PT-BR</NavLink>
                  </Link>
                </NavItem>
            </Nav>
            ...
            {!isAuth() && (
              <Nav >
                <NavItem>
                  <Link href="/signin">
                    <NavLink  style={{color:'white', cursor: 'pointer'}}>Entrar</NavLink>
                  </Link>
                </NavItem>
            
                <NavItem>
                  <Link href="/signup">
                    <NavLink style={{color:'white', cursor: 'pointer', marginLeft:'20px'}}>Cadastrar</NavLink>
                  </Link>
                </NavItem>
              </Nav>
            )}
